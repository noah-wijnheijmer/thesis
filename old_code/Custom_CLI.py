...
def excel_output(image,number,number_of_part,number_of_part_in_Green,number_of_part_in_Blue,inpu_cell_size,inpu_part_size,zero_cell,clean_cell,fp2):
    ...
    number_of_part_in_Green=pd.DataFrame(number_of_part_in_Green,columns=['Particles per cell in the Green Channel'])
    number_of_part_in_Blue=pd.DataFrame(number_of_part_in_Blue,columns=['Particles per cell in the Blue Channel'])
